...
| Watch-list mechanism (`SUBMISSIONS.md` — open leaderboard, community contributions) | Watch-list mechanism (`watch-items.md` — watch items with revisit conditions, audit sweep) | Same concept but different domain. Theirs tracks benchmark entries. Ours tracks anything deferred on a condition. |
