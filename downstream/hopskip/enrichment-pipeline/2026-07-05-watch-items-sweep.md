# Watch-List Sweep — enrichment-pipeline
...
Also update the Audit doc structure in `docs/audits/README.md` — add "watch-list sweep" as a fifth domain alongside the existing four (ADR coherence, docs vs reality, code + migrations, GitHub backlog).
